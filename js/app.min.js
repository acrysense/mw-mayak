...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    //             { x: '100%' },
    //             { x: '0%', delay: 0.5, ease: 'power2.out' },
    //             'startFirst'
    //         );

    //         tl.fromTo('.main__preview', 
    //             { clipPath: 'inset(0% 0% 100% 0%)' },
    //             { clipPath: 'inset(0% 0% 0% 0%)', duration: 0.8, delay: 0.7 },
    //             'startFirst'
    //         );

    //         tl.fromTo('.main__logo', 
    //             { x: '-10%', opacity: 0 },
    //             { x: '0%', opacity: 1, delay: 0.9, ease: 'power2.out' },
    //             'startFirst'
    //         );
    ...
    //             { x: '10%', y: '100%', delay: 0.5 },
    //             'startSecond'
    //         );

    //         tl.to('.main__decor--third', 
    //             { x: '100%', delay: 0.5, ease: 'power1.out' },
    //             'startSecond'
    //         );
    ...
    //         tl.to('.main__logo', 
    //             { x: '4%', opacity: 0, delay: 0.5, duration: 0.8, ease: 'power1.out' },
    //             'startSecond'
    //         );

    //         tl.fromTo('.main__bg', 
    //             { clipPath: 'inset(100% 0% 0% 0%)' },
    //             { clipPath: 'inset(0% 0% 0% 0%)', delay: 0.5 },
    //             'startSecond'
    //         );
    ...
    //             { x: '100%', delay: 0.5, duration: 0.8 },
    //             'startThird'
    //         );

    //         tl.to('.main__decor--fifth', 
    //             { width: '100%', delay: 0.5, duration: 0.8 },
    //             'startThird'
    //         );

    //         tl.to('.main__bg', 
    //             { y: '19.9305555556vw', delay: 0.5, duration: 0.8 },
    //             'startThird'
    //         );
    ...
    //         tl.fromTo('.header', 
    //             { opacity: 0 },
    //             { opacity: 1, delay: 1.3, duration: 0.8 },
    //             'startThird'
    //         );
    ...
    //         tl.fromTo('.main-inner__decor--top', 
    //             { x: '100%' },
    //             { x: '-100%', delay: 0.5 },
    //             'startFirst'
    //         );

    //         tl.fromTo('.main-inner__decor--bottom', 
    //             { x: '-100%' },
    //             { x: '100%', delay: 0.5 },
    //             'startFirst'
    //         );
    ...
    //         tl.fromTo('.main-inner__block', 
    //             { opacity: 0 },
    //             { opacity: 1, duration: 0.8 },
    //             'startThird'
    //         );

    //         tl.fromTo('.main-inner__bottom', 
    //             { opacity: 0 },
    //             { opacity: 1, duration: 0.8 },
    //             'startThird'
    //         );

    //         const [bgTween] = tl.getTweensOf('.main-inner__bg img');
    ...
    //             gsap.set('.main-inner__bg img', { y: value })
    //         }
