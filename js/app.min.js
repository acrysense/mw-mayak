...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (complexBg && complexInfo) {
    complexBg.forEach(function (area) {
      ...
      area.addEventListener('mouseover', function () {
        if (!isTouchDevice) {
          var selector = ".complex__bg-svg[data-complex=\"".concat(complex, "\"][data-value=\"").concat(value, "\"]");
          var target = document.querySelector(selector);
          var offset = (8 - value) * 40;
          target.classList.add('is--active');
          complexInfo.classList.add('is--active');
          complexInfo.classList.add("complex-info--".concat(complex));
          complexInfo.classList.add("complex-info--stage-".concat(value));
      ...
      area.addEventListener('mouseout', function () {
        if (!isTouchDevice) {
          document.querySelectorAll('.complex__bg-svg').forEach(function (item) {
            return item.classList.remove('is--active');
          });
          complexInfo.classList.remove('is--active');
          complexInfo.classList.remove("complex-info--".concat(complex));
          complexInfo.classList.remove("complex-info--stage-".concat(value));
