...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Загружаем и запускаем первую анимацию в первый контейнер
  var firstAnimation = lottie.loadAnimation({
    container: document.getElementById('main-first-animation'),
    // первый слой
    renderer: 'svg',
    loop: false,
    // первая анимация проигрывается один раз
    autoplay: true,
    path: 'main-first.json' // путь к JSON файлу первой анимации
  });

  // Когда первая анимация завершена, запускаем вторую и скрываем первую
  firstAnimation.addEventListener('complete', function () {
    ...
    // Запускаем вторую анимацию во втором слое
    var secondAnimation = lottie.loadAnimation({
      container: secondContainer,
      // второй слой
      renderer: 'svg',
      loop: true,
      // вторая анимация будет зациклена
      autoplay: true,
      path: 'main.json' // путь к JSON файлу второй анимации
    });

    // Скрываем первую анимацию плавно
    setTimeout(function () {
      firstContainer.classList.add('hidden'); // Плавно скрываем первую анимацию
    }, 50); // Небольшая задержка, чтобы вторая анимация успела начать воспроизводиться
  });
  // }
