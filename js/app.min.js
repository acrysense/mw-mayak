...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // lottie
  var preloaderWaves = document.getElementById('preloader-animation');
  ...
  if (mainFirstWaves && mainSecondWaves) {
    ...
    firstAnimation.addEventListener('DOMLoaded', function () {
      preloaderWaves.classList.add('is--hidden');
      mainFirstWaves.classList.remove('is--hidden');
      firstAnimation.play();
    });
